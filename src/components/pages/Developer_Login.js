        ...
        <div className="py-4">
            ...
            <div className="row">
                ...
                <div className="col border rounded shadow p-3">
                    ...
                    <div className="row">
                        <div className="col"><Link className="btn btn-secondary mb-3 container-fluid" to="/Developer_Login">Login</Link></div><div className="col"><Link class="btn btn-secondary container-fluid" to="/Developer_Register">Register</Link></div>
                    </div>
